...
const loginLoading = writable(false);
const signupLoading = writable(false);
const selectedGroupLoading = writable(false);
const userInit = {
  isLoggedIn: false,
  id: null,
  email: "",
...
JSON.parse(browser) || userInit;
const userDataStore = writable(browser);
